...
[_mission,_position,"Hard","Drone Pilot","MainHero",true] call mission_init;
...
//Static Guns
[[[(_position select 0) - 7, (_position select 1) + 19, 0]],"KORD_high_TK_EP1","Hard","US_Soldier_Medic_EP1","Bandit",0,2,"Random","Random",_mission] call spawn_static;
...
diag_log format["WAI: [Mission:[Hero] Drone Pilot]: Ended at %1",_position];
