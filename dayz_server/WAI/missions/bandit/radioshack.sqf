if(isServer) then {
	...
	private 		["_baserunover0","_baserunover1","_baserunover2","_baserunover3","_baserunove4","_baserunover5","_baserunover6","_baserunover7","_baserunover8","_baserunover9","_baserunover10","_baserunover11","_baserunover12","_baserunover13","_baserunover14","_mission","_directions","_position","_crate","_crate_type","_num"];
	...
	[_mission,_position,"hard","Radio Tower","MainBandit",true] call mission_init;
...
_baserunover14 = createVehicle ["MAP_t_carpinus2s",[(_position select 0) + 28, (_position select 1) - 13,-0.02],[], 0, "CAN_COLLIDE"];
	...
	[[(_position select 0) - 1.2, (_position select 1)  - 20, 0],_num,"extreme",["random","at"],4,"random","Hero","random",["Hero",150],_mission] call spawn_group;
	[[(_position select 0) - 4, (_position select 1) + 16, 0],4,"hard","random",4,"random","Hero","random","Hero",_mission] call spawn_group;
	[[(_position select 0) - 17, (_position select 1) - 4, 0],4,"random","random",4,"random","Hero","random","Hero",_mission] call spawn_group;
	[[(_position select 0) + 14, (_position select 1) - 3, 0],4,"random","random",4,"random","Hero","random","Hero",_mission] call spawn_group;
	...
	_complete = [
		...
		"Heroes set up a radio tower to spread hero propaganda..Check your map",	// mission announcement
	...
	if(_complete) then {
		[_crate,10,5,30,5,2] call dynamic_crate;
			};
	
	// End of mission
	diag_log format["WAI: Mission:[Bandit] Radio Tower ended at %1 ended",_position];
