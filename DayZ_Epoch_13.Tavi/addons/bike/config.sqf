...
DZE_DEPLOYABLES_CONFIG = [
	...
	//Virtual Garage
	["ItemTrashPaper",	[0,6,0],5,-1,false,false,false,true,true,false,false,["Land_MBG_Garage_Single_C"],[],["ItemTrashPaper"],"true"],
	//Virtual Garage Spawn
	["ItemCards",[0,6,0],5,-1,false,false,false,true,true,false,false,["HeliHCivil"],[],["ItemCards"],"true"]
	
	// deploy Garage
	//_clickItem_deployOffset	_packDistance	_damageLimit	_packAny	_cargo		_ammo	_hive	_plot	_simulation _road	_deployables					_near	_parts				_condition
