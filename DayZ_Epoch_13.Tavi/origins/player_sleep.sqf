...
//
// Animation references - http://community.bis...ki/ArmA2:_Moves
...
_bloodAmount = 12000; // Total amount of blood to give back to player on sleep (12000 is the max life for a player)

_sleepCooldown = 120; // This is how long in seconds before you can sleep again
