...
_repair_costs = [
	["Air",5000], // 4000 worth is 4 10oz gold.
	["AllVehicles",3000] // 2000 worth is 2 10oz gold for all other vehicles
];

// rearm settings
_rearm_enable = true; // enable or disable the rearm option
_rearm_defaultcost = 100000; // Default cost to rearm a weapon. (10000 worth == 1 briefcase)
