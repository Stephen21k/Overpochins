...
if (Z_SingleCurrency) then {
	_formattedText = format [
		...
		_class,
		_magText,
		if (_sellPrice >= 9999999) then {"UNBUYABLE HERE";} else { if (_sellPrice >= 0) then {_sellPrice} else {"";};}, //#5
		if (_buyPrice >= 9999999) then {"UNBUYABLE HERE";} else {if (_buyPrice >= 0) then {_buyPrice} else {"";};},	//#6
	...
	_formattedText = format [
		...
		_class,
		_magText,
		if (_sellPrice >= 9999999) then {"UNBUYABLE HERE";} else { if (_sellPrice >= 0) then {_sellPrice} else {"";};},
		if (_buyPrice >= 9999999) then {"UNBUYABLE HERE";} else {if (_buyPrice >= 0) then {_buyPrice} else {"";};},																  
		_sellCurrency,
		_buyCurrency,
		_picSell,
		_picBuy,  
